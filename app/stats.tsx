        ...
        return (
            <Card style={styles.item}>
                ...
                <Text style={[typography.caption]}>
                    {item.mode.toUpperCase()} · {Math.round(item.duration / 60)}
                    m · {t("stats.focus")} {item.concentration}/10 ·{" "}
                    {item.pickups} {t("stats.pickups")}
                </Text>
            </Card>
        );
    }
                ...
                ListHeaderComponent={
                    <View>
                        ...
                        <Card>
                            ...
                            <Text style={[typography.caption]}>
                                {t("stats.avgConcentration")}:{" "}
                                {avgConc.toFixed(1)}/10
                            </Text>
                        </Card>
